...
const HowItWorksPage = () => {
  return (
    <div className='howItWorksPage'>
      ...
      <p><strong>Can I select my meals?</strong></p>
      <p>Yes! You can choose your meals every week.</p>

      <p><strong>How will my food stay cool?</strong></p>
      ...
      <p><strong>What if I don't want a delivery every week?</strong></p>
      <p>No worries. You can easily skip a week (or several!) when you need to. Just be sure to do so by your cutoff time 5 days prior to your delivery.</p>
    </div>
  )
}
